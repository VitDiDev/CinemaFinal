...
function RegisterComponent() {
    const imgSrc = 'https://img.freepik.com/free-vector/login-concept-illustration_114360-739.jpg?w=2000';
    ...
    return (
        <div className='register__content'>
            <div style={{paddingTop:60}} className="row container mx-auto hello">
                <div className="col-sm-12 col-md-6">
                    <img className='img-fluid register-img' src={imgSrc} alt="..." />
                </div>
                <div className="col-sm-12 col-md-6">
