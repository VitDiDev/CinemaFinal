...
export default function Header() {
  ...
  return (
    <header >
      <nav className="styleNav navbar navbar-expand-lg navbar-dark" style={{height:100, paddingLeft:200}}>
        <NavLink className="navbar-brand" to='/'><img style={{width: 200, height:150}} src="https://inthienha.com/wp-content/uploads/CGV-Cinemas.png" alt="..."
        /></NavLink>
